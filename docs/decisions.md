...
**ADR-21** · Commit format. `<type>(<scope>): <what, imperative, max 60 chars>`. Types: feat · fix · refactor · test · chore · style. Scopes: auth · home · constellation · settings · offline · reminder · backend · deps. No period at end. Imperative verb: add, fix, wire, extract, replace. One concern per commit. Body only when the why is not obvious: one line, blank line after subject.
